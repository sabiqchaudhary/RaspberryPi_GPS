...
#	
#	Function:
#	Takes GPS position data and writes it to a file, so that it can be used by a nodejs program 
#   alternatively it is displayed on the console.  
#	
...
#functions 
def check_serial(): #Checks whether there is a GPS connected or whether the data will have to be provided.
